...
print("printing rodent silhoute coefficients:")
print(rodent_silhouette_scores)
print("for cluster sizes:")
print(x_vals)
...
f.tight_layout()
plt.savefig(save_name)
print("printing human silhoute coefficients:")
print(human_silhouette_scores)
print("for cluster sizes:")
print(x_vals)