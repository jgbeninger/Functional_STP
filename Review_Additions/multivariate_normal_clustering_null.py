...
for i in range(0, 1000):
    ...
    try:
        ...
        silhouette_score = metrics.silhouette_score(PCA_like_synthetic_values, clustering.labels_)
        scatter_plot_clustering(unsupervised_scatter(clustering, PCA_like_synthetic_values), "./reviewfigssmall/scatters_multivariate_Gaussian/scatter"+str(sys.argv[1])+"_"+str(i), silhouette_score)
    except:
...
save_name = "./reviewfigssmall/multinormal_peak_silhouette_coefficients.svg"
...
name = "./reviewfigssmall/multivariate_Gaussian_pickles/MultivariateGaussianResults" +sys.argv[1] +".p"
file = open(name, "wb")
