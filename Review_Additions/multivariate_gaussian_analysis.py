...
with open("./reviewfigssmall/multivariate_Gaussian_pickles/MultivariateGaussianResults0.p", "rb") as input_file:
    results0 = pickle.load(input_file)
    
with open("./reviewfigssmall/multivariate_Gaussian_pickles/MultivariateGaussianResults1.p", "rb") as input_file:
    results1 = pickle.load(input_file)
    
with open("./reviewfigssmall/multivariate_Gaussian_pickles/MultivariateGaussianResults2.p", "rb") as input_file:
...
f.set_dpi(1200)
f.tight_layout()
plt.savefig("./reviewfigssmall/multivariate_gaussian_histogram.svg", transparent=True)