...
for i in range(1, len(sys.argv)):
    ...
    print(file_name)
    pair_id = file_name.split('_')[9] #split on "full_" for 8 for two step, sst 9 for human
    pre_type= file_name.split('_')[7] #6 for two step, sst 7 for human
    post_type= file_name.split('_')[8] #7 for two step, sst 8 for human
