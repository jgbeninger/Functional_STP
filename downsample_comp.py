...
#1.3mM
with open("./fig4/dists/modelprebootstrapdists1.3mMdownmlp.p", "rb") as input_file:
...
with open("./fig4/dists/physprebootstrapdists1.3mMdownmlp.p", "rb") as input_file:
...
#2mM
with open("./fig4/dists/modelprebootstrapdists2mMdownmlp.p", "rb") as input_file:
...
with open("./fig4/dists/physprebootstrapdists2mMdownmlp.p", "rb") as input_file:
...
save_name = "./fig4/multi_label_post_bootstrap_histmodel1.3_2mM.svg"
#save_name = "./Figures/fig3/multi_label_post_bootstrap_bar_2mM.svg"
#save_name = "./Figures/fig3/multi_label_post_shuffle_bar_1.3mM.svg"
f.set_size_inches((2.3622, 2.465))
f.set_dpi(1200)
...
save_name = "./fig4/multi_label_post_bootstrap_histphys1.3_2mM.svg"
#save_name = "./Figures/fig3/multi_label_post_bootstrap_bar_2mM.svg"
#save_name = "./Figures/fig3/multi_label_post_shuffle_bar_1.3mM.svg"
f.set_size_inches((2.3622, 2.465))
f.set_dpi(1200)
...
plt.ylabel("Accuracy - Baseline")
#plt.ylim([0,1])
save_name = "./fig4/baseline_differences_post_bootstrap.svg"
#save_name = "./Figures/fig3/multi_label_pre_bootstrap_1.3mM.svg"
#save_name = "./Figures/fig3/multi_label_pre_shuffle_1.3mM.svg"
f.set_size_inches(((4.72, 2.465)))
f.set_dpi(1200)
